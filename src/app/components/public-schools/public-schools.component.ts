...
@Component({
  selector: 'app-public-schools',
  templateUrl: './public-schools.component.html',
  styleUrl: './public-schools.component.scss'
})
export class PublicSchoolsComponent {
// 1
schools: Ischool[] = [];
...
loadSchools(): void {
  ...
  this.schools = this.originalSchools.filter(school => school.schoolType === 'PUBLIC').slice(0, this.schoolsToShow);
