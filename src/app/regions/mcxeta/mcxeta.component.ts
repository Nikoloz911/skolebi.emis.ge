...
@Component({
  selector: 'app-mcxeta',
  templateUrl: './mcxeta.component.html',
  styleUrl: './mcxeta.component.scss'
})
export class McxetaComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'მცხეთა-მთიანეთი').slice(0, this.schoolsToShow);
