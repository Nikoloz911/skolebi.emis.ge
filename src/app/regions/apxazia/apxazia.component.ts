...
@Component({
  selector: 'app-apxazia',
  templateUrl: './apxazia.component.html',
  styleUrl: './apxazia.component.scss'
})
export class ApxaziaComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'აფხაზეთი').slice(0, this.schoolsToShow);
