...
@Component({
  selector: 'app-kaxeti',
  templateUrl: './kaxeti.component.html',
  styleUrl: './kaxeti.component.scss'
})
export class KaxetiComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'კახეთი').slice(0, this.schoolsToShow);
