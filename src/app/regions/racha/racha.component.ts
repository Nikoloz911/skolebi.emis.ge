...
export class RachaComponent {
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'რაჭა-ლეჩხუმი და ქვემო სვანეთი').slice(0, this.schoolsToShow);
