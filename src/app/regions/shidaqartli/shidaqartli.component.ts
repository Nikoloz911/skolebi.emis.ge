...
@Component({
  selector: 'app-shidaqartli',
  templateUrl: './shidaqartli.component.html',
  styleUrl: './shidaqartli.component.scss'
})
export class ShidaqartliComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'შიდა ქართლი').slice(0, this.schoolsToShow);
