...
@Component({
  selector: 'app-imereti',
  templateUrl: './imereti.component.html',
  styleUrl: './imereti.component.scss'
})
export class ImeretiComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'იმერეთი').slice(0, this.schoolsToShow);
