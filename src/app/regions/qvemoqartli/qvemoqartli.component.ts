...
@Component({
  selector: 'app-qvemoqartli',
  templateUrl: './qvemoqartli.component.html',
  styleUrl: './qvemoqartli.component.scss'
})
export class QvemoqartliComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'ქვემო ქართლი').slice(0, this.schoolsToShow);
