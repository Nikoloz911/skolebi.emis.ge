...
@Component({
  selector: 'app-javaxeti',
  templateUrl: './javaxeti.component.html',
  styleUrl: './javaxeti.component.scss'
})
export class JavaxetiComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'სამცხე-ჯავახეთი').slice(0, this.schoolsToShow);
