...
@Component({
  selector: 'app-samegrelo',
  templateUrl: './samegrelo.component.html',
  styleUrl: './samegrelo.component.scss'
})
export class SamegreloComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'სამეგრელო-ზემო სვანეთი').slice(0, this.schoolsToShow);
