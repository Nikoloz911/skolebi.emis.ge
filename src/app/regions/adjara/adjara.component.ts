...
@Component({
  selector: 'app-adjara',
  templateUrl: './adjara.component.html',
  styleUrl: './adjara.component.scss'
})
export class AdjaraComponent {
  schools: Ischool[] = [];
  ...
  loadSchools(): void {
    ...
    this.schools = this.originalSchools.filter(school => school.regionName === 'აჭარა').slice(0, this.schoolsToShow);
